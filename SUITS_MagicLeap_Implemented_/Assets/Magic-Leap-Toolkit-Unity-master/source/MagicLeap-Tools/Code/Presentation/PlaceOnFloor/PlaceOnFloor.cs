...
namespace MagicLeapTools
{
    ...
    public class PlaceOnFloor : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            mainScreen = GameObject.FindGameObjectWithTag("Main Screen").transform;
            meshNode = GameObject.FindGameObjectWithTag("MeshNode");
        ...
        private bool LookingAtFloorDetermination()
        {
            ...
            if (Physics.Raycast(mainScreen.position, mainScreen.forward, out hit))
            {
