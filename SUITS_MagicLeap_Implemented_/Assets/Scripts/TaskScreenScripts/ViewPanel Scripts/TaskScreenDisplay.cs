...
public class TaskScreenDisplay : ScreenDisplay
{
   ...
   public TaskScreenDisplay(TaskScreenManager manager)
   {
    ...
    private void displayTitlePanel()
    {
        ...
        textTitle.text = "Task: " + list[counter][0] ;
    ...
    private void navShortcutDisplay()
    {
        ...
        if (list[counter][1] == "Navigation")
        {
            ...
            manager.navShortcut.GetComponentInChildren<TextMeshPro>().text = headerText + footerText;

           
        }
        else
        {
            manager.navShortcut.SetActive(false);
        }
    }
