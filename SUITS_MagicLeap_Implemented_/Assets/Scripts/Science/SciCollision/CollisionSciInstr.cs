...
public class CollisionSciInstr : GenericCollision, ICollisionTask
{
    ...
    {
        CollisionSciManager manager = GameObject.FindWithTag("ScienceScreen").GetComponent<CollisionSciManager>();
